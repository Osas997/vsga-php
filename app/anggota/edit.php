                ...
                <div class="col-md-9 col-lg-10">
                    <div class="content">
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="fs-3">Edit anggota</p>
                            <a href="/app/anggota/index.php" class="btn btn-primary">Kembali</a>
                        </div>
                        <div class="row my-3">
                            <div class="col-md-8 col-12">
                                <form method="post" action="/proses/anggota/update.php?id=<?= $data['id'] ?>" onsubmit="return validateData(event)" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <img src="/public/img/upload/<?= $data['foto'] ?>" alt="<?= $data['nama'] ?>" class="img-thumbnail">
                                        </div>
                                    </div>
